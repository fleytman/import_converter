...
Предполагается, что все файлы для конвертирования имеют первоначальную кодировку cp1251 и окончания строк crlf (https://github.com/fleytman/import_converter/issues/1#issuecomment-276956924)
